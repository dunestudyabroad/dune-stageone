...
const Footer = () => {
  ...
  return (
    <footer className="relative">
      ...
      {showPrivacyModal && (
        <>
          <div className="bg-black/30 backdrop-blur-lg h-full w-full fixed inset-0" onClick={() => setShowPrivacyModal(false)} />
          <div className="fixed inset-0 z-50 flex items-center justify-center">
            <div className="max-w-6xl mx-auto bg-white pt-7 pb-7  py-32 dark:bg-neutral-900 lg:my-10 z-[60]  w-full min-h-full lg:h-fit lg:min-h-0 lg:rounded-3xl font-sans relative">
              ...
              <h2 className="text-4xl text-center font-bold mb-4">Privacy Policy</h2>
              <p className="text-2xl px-32 text-black text-left">
                Dune Study Metro is the sole owner of the information collected through this website and associated platforms. The privacy and trust
                of our students, clients, and website visitors is of utmost importance to us. We deeply value the information you share and are
                committed to protecting it with the highest level of care.
              </p>
              <p className="text-2xl pt-16 px-32 pb-7 text-black text-left">
                We assure you that under no circumstances will your personal information be sold, rented, or disclosed to third parties for commercial
                purposes. Any data collected will be used solely for providing our educational consulting services and as described in
                this Privacy Policy
              </p>
            </div>
          </div>
      ...
      <div className="bg-[#2B2B60]">
        <div className="flex flex-col md:flex-row justify-between mx-6 md:mx-24 py-8 md:py-14">
          <div className="flex justify-center gap-5 md:justify-start mb-6 md:mb-0">
            ...
            <Image alt="footer logo 2" width={200} height={240} src={logo2} className="hidden md:block pt-4" />
          </div>
          <div className="flex justify-center gap-5 md:justify-start mb-6 md:mb-0">
            <Image alt="footer logo mobile" width={240} height={240} src={logo2} className="md:hidden" />
          </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center mx-6 md:mx-24 pt-6 md:pt-9 pb-8 md:pb-14">
          <div className="flex justify-center md:justify-start gap-4 mb-4 md:mb-0">
            ...
            <Link target="_blank" href="https://www.facebook.com/share/1EcdrNpkNP/?mibextid=wwXIfr">
              <Meta />
            </Link>
            <Link target="_blank" href="https://youtube.com/@dunestudyabroad?si=CTCfsXeNVSpuJqOQ">
              <Yt />
            </Link>
          </div>
          ...
          <div className="text-[#9583FE] text-[13px] text-center md:text-left mb-4 md:mb-0">
            <p>
              <button onClick={() => setShowPrivacyModal(true)} className="hover:underline focus:outline-none">
                Privacy Policy
              </button>
